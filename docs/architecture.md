...
[README](../README.md) · [Product scope](product.md) · [Database](database.md) · [Evaluator plan](evaluator-plan.md)

![Sweep architecture: Gmail calls a Python API on Modal; a controller selects messages, a worker runs Laya and changes Gmail, and Firestore saves job records.](assets/architecture.svg)
